...
module DELD_PFD(clk_ref, clk_fb, up, dn);
...
// are not moved to the inputs (which are nodes C2 and F2
// respectively) of the negative latches ? 
...
assign R1 = ~(UP1 ^ DN1);  // XNOR gate #9
assign R2 = ~(UP2 & DN2);  // NAND gate #9
