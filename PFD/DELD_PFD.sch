...
N 290 -40 290 -10 {lab=0}
N 290 -140 290 -100 {lab=VDD}
...
N -840 -180 -840 -140 {lab=DN1}
N -840 -140 -580 -140 {lab=DN1}
N -520 -180 -520 -60 {lab=DN2}
N -460 -180 -460 -110 {lab=UP2}
N -840 -110 -460 -110 {lab=UP2}
N -580 -140 -580 -60 {lab=DN1}
N -840 -110 -840 -60 {lab=UP2}
N -900 -180 -900 -60 {lab=UP1}
...
C {gnd.sym} 290 -10 0 0 {name=l2 lab=0}
C {lab_pin.sym} 290 -140 0 1 {name=p12 sig_type=std_logic lab=VDD}
C {vsource.sym} 290 -70 0 0 {name=V1 value=3.3 savecurrent=true}
...
plot v(x3.NL1_in)+4 v(x3.NL2_in)+4 v(x3.reset_out) v(UP1)
.endc" }
...
C {lab_pin.sym} -580 -80 0 0 {name=p9 sig_type=std_logic hide=true lab=DN1}
C {lab_pin.sym} -520 -80 0 1 {name=p15 sig_type=std_logic hide=true lab=DN2}
