...
N 620 -640 660 -640 {lab=VDD}
N 480 -450 620 -450 {lab=Y}
N 710 -520 770 -520 {lab=VDD}
N 620 -450 760 -450 {lab=Y}
N 480 -580 760 -580 {lab=VDD}
N 620 -640 620 -580 {lab=VDD}
N 400 -520 440 -520 {lab=A}
N 800 -520 840 -520 {lab=B}
N 760 -580 760 -550 {lab=VDD}
N 480 -580 480 -550 {lab=VDD}
...
C {ipin.sym} 660 -160 0 1 {name=p4 lab=GND}
C {ipin.sym} 660 -640 0 1 {name=p6 lab=VDD}
...
C {lab_pin.sym} 710 -520 0 0 {name=p8 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 620 -600 0 0 {name=p11 sig_type=std_logic lab=VDD}
